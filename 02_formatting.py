...
"""
password = "firefly" # I added a password
valid_password = password.lower() # allowed password to be lowercase
valid_password2 = password.upper() # allowed password to be uppercase
...
ap = f"result: {apples:.2f}"
Or  = f"result: {oranges:.2f}"
